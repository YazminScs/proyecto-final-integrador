...
<html>
    <head>
        ...
        <link href="<%=request.getContextPath()%>/css/style-card.css" rel="stylesheet" type="text/css"/>
        <link href="<%=request.getContextPath()%>/css/style-arrow-slick.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <div class="container">
            <div class="slider">
