...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/style-header.css?v=1.0">
    </head>
    <body>
        <header>
                    ...
                    <div
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="<%=request.getContextPath()%>/NosotrosIntegrador/nosotros.jsp">AboutTech</a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="<%=request.getContextPath()%>/UbicaiconesIntegrador/ubicaciones.jsp">LocationTech</a>
                                </li>
