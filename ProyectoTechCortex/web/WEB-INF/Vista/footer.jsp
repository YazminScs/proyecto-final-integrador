...
<html>
    <head>
        ...
        <link href="<%=request.getContextPath()%>/css/style-menu.css" rel="stylesheet" type="text/css"/>
        <link href="<%=request.getContextPath()%>/css/style-footer.css" rel="stylesheet" type="text/css"/>
