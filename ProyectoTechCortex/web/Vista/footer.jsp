            ...
            <div class="container">
                <div class="footer-row">
                    ...
                    <div class="footer-links">
                        <h4>Ayuda</h4>
                        <ul>
                            <li><a href="<%=request.getContextPath()%>/UbicaiconesIntegrador/ubicaciones.jsp">LocationTech</a></li>
                            <li><a href="<%=request.getContextPath()%>/NosotrosIntegrador/nosotros.jsp">AboutTech</a></li>
