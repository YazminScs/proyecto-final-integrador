                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-flex mb-3 justify-content-start">
                            ...
                            <form action="<%=request.getContextPath()%>/ControladorAdmin" method="GET" style="display: inline;">
                                <input type="hidden" name="accion" value="generarExcelCategoria">
                                    ...
                                    <table class="table table-striped table-dark" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <c:forEach var="categoria" items="${listaCategorias}">
                                                <tr>
                                                    <td class="text-truncate" style="max-width: 100px;">${categoria.idCategoria}</td>
                                                    <td class="text-truncate" style="max-width: 100px;">${categoria.nombre}</td>
                                                    <td>
                                                        <!-- Botón para abrir el modal -->
                                                        <button 
                                                            type="button" 
                                                            class="btn btn-outline-info btn-sm btn-editar-categoria" 
                                                        ...
                                                        <form action="<%=request.getContextPath()%>/ControladorAdmin?accion=eliminarCategoria" method="GET" style="display: inline-block;">
                                                            <input type="hidden" name="id" value="${categoria.idCategoria}">
                                                            <button type="submit" name="accion" value="eliminarCategoria" class="btn btn-outline-danger">
            ...
            <div class="modal fade" id="editarCategoriaModal" tabindex="-1" aria-labelledby="editarCategoriaModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="editarCategoriaForm" action="<%=request.getContextPath()%>/ControladorAdmin" method="POST">
                            <input type="hidden" name="accion" value="editarCategoria">
                            <input type="hidden" id="CategoriaId" name="CategoriaId">
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label for="nombreCategoriaEditar" class="form-label">Nombre</label>
